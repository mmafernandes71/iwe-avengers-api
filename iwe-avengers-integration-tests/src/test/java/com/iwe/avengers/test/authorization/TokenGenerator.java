...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "4dish438b1jdksuqp70i4oba4k";
		final String userPoolId = "us-east-1_vvx2u0t6p";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "mmafernandes71");
